...
public class DirectPrintJournalChicago extends Command {
    /**
     * Konstruktor des Kommandos "direct print journal chicago"
     */
    DirectPrintJournalChicago() {
    ...
    public void execute(LiteratureManager literatureManager, String input) {
        ...
        if (splitCutString[3].isEmpty()) {
            ...
            Terminal.printLine("(" + author1[1] + ", " + year + ")" + " " + author1Abr + ", and " + author2Abr
                    + ". \"" + title + ".\" "
                    + journalTitle + " (" + year  + ").");
            return;
        ...
        Terminal.printLine("(" + author1[1] + ", " + year + ")" + " " + author1Abr
                + ", " + author2Abr + ", and " + author3Abr + ". \"" + title + ".\" "
                + journalTitle + " (" + year  + ").");
    }
}
